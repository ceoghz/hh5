<template>
    <view class="calendar-wrapper">
        <view class="header" v-if="headerBar">
            <view class="pre" @click="changeMonth('pre')"><image style="height:20upx;width: 20upx;" src="../../static/img/sjx.png" mode=""></image></view>
            <view>{{y+'年'+formatNum(m)+'月'}}</view>
            <view class="next" @click="changeMonth('next')"><image style="height:20upx;width: 20upx;" src="../../static/img/sjx1.png" mode=""></image></view>
        </view>
        <view class="week">
