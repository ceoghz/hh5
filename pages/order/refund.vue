			...
			<view class="refund-type">
				...
				<view class="refund-type-main" >
					...
					<view class="refund-type-main-3 d-flex j-sb">
						...
						<view style="font-size: 32upx;font-weight: 600;color: #FA6E39;margin-right: 20upx;">¥{{productinfo.z_price}}</view>
					</view>
					<view class="refund-type-main-4" style="margin-top: 0upx;">
						不可修改，最多¥{{productinfo.z_price}}，含发货邮费¥{{productinfo.preferential_amount}}，其中包含部 分红包
					</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			submitRequest(){
				...
				this.$http.post('',{
					...
					action:'order',
					app:'refund',
					order_details_id:this.productinfo.id,///订单详情id
					type:this.type,//退款类型
					reason:this.reason,
					explain:this.why,
					images:this.imgArr
		...
		onLoad(options) {
			...
			console.log('productinfo',this.productinfo,options.type)
		},
		created() {
