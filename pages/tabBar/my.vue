		...
		<view class="myd-main">
				...
				<view class="myd-main-header-info d-flex j-sb " style="">
					<view class="avtar d-flex a-center">
						...
						<view class="avtar-r">
							...
							<!-- #endif -->
							<!-- #ifdef H5 -->
							<button   v-if="userInfo==''" class="shouquan"   size="mini" plain=true>登录</button>
							<text v-if="userInfo!==''">{{userInfo.user_name}}</text>
							<!-- #endif -->
						</view>
					</view>
			...
			<view class="myd-main-content">
				<view class="user-lines d-flex j-sb">
					<view @click="jumpcoupons" class="" style="border-left: 2upx solid #F4F4F4;">
						<text>优惠卷</text>
						<text>{{userInfo!==''?userInfo.coupon_num:0}}</text>
					</view>
					<view @click="jumpGrade" class="" style="border-left: 2upx solid #F4F4F4;">
						<text>公益积分</text>
				...
				<view class="service">
					...
					<view class="service-b">
						<view style="height: 84upx;width: 100%;" v-for="(item,index) in abb_list" :key='index' @click="jumpClick(item.adr)" >
							<view class="d-flex j-sb" v-if="item.adr!=''" style="height: 100%;width: 100%;">
								<view class="d-flex a-center" v-if="item.adr!=''" style="height: 100%;">
							...
							<button
								class="kf_button d-flex j-sb" 
								style="background: none;padding: 0;height: 100%;border: none;"
								type="" 
								size="12"
								open-type="contact" 
							...
							>
							   ...
							   <view class="abb d-flex a-center" style="height: 100%;">
									<image style="width: 60upx;height: 60upx;" src="../../static/img/btn_back.png" mode=""></image>
							   </view>
							</button>
						</view>
		...
		data(){
			return{
				abb_list:[
					...
					{img_src:'../../static/img/icon_collection@2x(2).png',name:'在线客服',adr:''},
					{img_src:'../../static/img/icon_collection@2x(3).png',name:'关于我们',adr:'/pages/personal/aboutMe'},
